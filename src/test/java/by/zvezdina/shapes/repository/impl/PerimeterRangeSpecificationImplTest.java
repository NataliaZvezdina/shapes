...
public class PerimeterRangeSpecificationImplTest {
    private double testMinPerimeter = 2;
    private double testMaxPerimeter = 10;
    private PerimeterRangeSpecificationImpl specification =
            new PerimeterRangeSpecificationImpl(testMinPerimeter, testMaxPerimeter);
